...
@app.route('/<username>/topics/patch/<t_id>')
def topics_patch(username, t_id):
    # 博客内容编辑
    return send_file('templates/patch.html')


@app.route('/<username>/alipay')
def alipay_topic(username):
    # 打赏文章
    return send_file('templates/alipay.html')
